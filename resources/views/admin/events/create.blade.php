                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="summary"
                                  ...
                                  required
                                  placeholder="Brief overview of the event...">{{ old('summary') }}</textarea>
                        @error('summary')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    @error('banner_image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Max: 2MB. Recommended: 1200x600px</p>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    @error('thumbnail_image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Max: 2MB. Recommended: 600x400px</p>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    @error('og_image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Max: 2MB. Recommended: 1200x630px</p>
