<x-layouts.public>
    <x-slot name="title">Official Circulars</x-slot>
    <x-slot name="description">Access important announcements and official documents from Kandy District Scout Branch.</x-slot>
